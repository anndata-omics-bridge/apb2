# FragPipe (22.1-build02) runtime properties


# Please edit the following path to point to the correct location.
# In Windows, please replace single '\' with '\\'
database.db-path=/g/pcf/01_users/Frank/proteobench/LFQ_Astral/2025-05-20-decoys-contam-ProteoBenchFASTA_DDAQuantification.fasta.fas
...
fragpipe-config.bin-diann=/g/pcf/06_scripts/FragPipeCommandeR_FP22/fragpipe/tools/diann/1.8.2_beta_8/linux/diann-1.8.1.8
fragpipe-config.bin-python=\\\\pcf.embl.de\\pcf\\06_scripts\\FragPipeCommandeR_FP22\\Python39\\python.exe
fragpipe-config.tools-folder=/g/pcf/06_scripts/FragPipeCommandeR_FP22/fragpipe/tools
freequant.mz-tol=10
...
phi-report.filter=--sequential --prot 0.01 --razor
...
workdir=/g/pcf/01_users/Frank/proteobench/LFQ_Astral
