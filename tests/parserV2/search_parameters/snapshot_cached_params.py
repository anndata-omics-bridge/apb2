...
Run from the repository root::
    ...
    PYTHONPATH=tests uv run python -m parserV2.search_parameters.snapshot_cached_params
"""
...
from parserV2.search_parameters import test_cached_fixtures as cached
